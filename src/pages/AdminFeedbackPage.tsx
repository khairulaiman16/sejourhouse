...
export default function AdminFeedbackPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 flex flex-col items-center">
      <h1 className="text-3xl font-bold text-[#373643] mb-6 text-center">
      ...
      {loading ? (
        ...
        <div className="w-full max-w-6xl">
          {/* Desktop Table View */}
          <div className="hidden md:block overflow-hidden rounded-xl bg-white shadow-lg">
          ...
          <div className="md:hidden space-y-4">
            {feedbackList.map((fb) => (
              ...
              >
                ...
                <h2 className="text-lg font-semibold text-[#373643]">{fb.name}</h2>

                <p className="text-sm text-gray-600 mt-2">
                  <span className="font-medium text-[#18cb96]">Enjoyed:</span> {fb.enjoy_most}
                </p>

                <p className="text-sm text-gray-600 mt-1">
                  <span className="font-medium text-[#18cb96]">Improvement:</span> {fb.improvement}
                </p>
